...
if (isset($_POST["category_name"])) {
    ...
    if ($cat_name == "" || $cat_type == "" || $cate_id == ""||$category_image=="") {
        return false;
    } else {
...
if (isset($_POST['catID'])) {
    ...
    $productQry = "INSERT INTO `products` (`id`,`product_name`, `category_id`, `actual_Price`, `sell_Price`,`retailer_price`,  `wholesaler_price`,`dealer_price`,`img_path`,`primary_image`, `secondary_image`) VALUES ($id,'$addProduct_name','$catID','$addActual_Price','$addSell_Price','$retailer_Price','$wholesale_Price','$dealer_Price','$Plocation','$addPrimary_image','$addSecondary_image');";
    // INSERT INTO `products` (`id`,`product_name`, `category_id`, `actual_Price`, `sell_Price`, `img_path`,`primary_image`, `secondary_image`) VALUES ($id,'$addProduct_name','$catID','$addActual_Price','$addSell_Price','$Plocation','$addPrimary_image','$addSecondary_image');";
    $conn = dbConnecting();
...
if (isset($_POST['update_product_name'])) {
    ...
    $updateQRY = "UPDATE `products` SET `product_name`='$update_product_name',`actual_Price`='$update_actual_Price',`sell_Price`='$update_sell_Price',`retailer_price`='$update_retailer_Price',`wholesaler_price`='$update_wholesale_Price',`dealer_price`='$update_dealer_Price',`img_path`='$location',`primary_image`='$update_primary_image',`secondary_image`='$update_secondary_image'where id='$update_p_id';";
